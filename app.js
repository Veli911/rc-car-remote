...
function bindModeButtons() {
  modeButtons.forEach((button) => {
    button.addEventListener('click', () => {
      ...
      if (currentMode === 'tilt') {
        // Enter Tilt with a true physical zero. Do not silently use the
        // current phone pose as neutral, otherwise enabling Tilt while the
        // phone is already tilted makes that tilt become "0".
